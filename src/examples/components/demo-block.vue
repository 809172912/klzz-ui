<template>
  <div class="docs-demo-wrapper">
    <div :style="{height: isExpand ? `${contentHeight}px` : '0'}" class="demo-container">
      <div span="14" :id="contentBoxId">
...
<script lang="ts">
    ...
    export default class DemoBlock extends Vue {
        ...
        public contentHeight: any = 0;
        public contentBoxId: string = `contentBoxId_${new Date().getTime() * Math.random() * 100000000}`;
        // 定义methods
        public toggle(): void {
            this.contentHeight = document.querySelector(`#${this.contentBoxId}`).offsetHeight;
